...
bool function_7(bool a, bool b) { return a&b; }
bool function_8(bool a, bool b) { return !(a&b); }
bool function_2(bool a, bool b) { return a; }
bool function_13(bool a, bool b) { return !a; }
...
int main()
{
    ...
    printf("\nFUNCTION_7(0, 1, 2): ");
    logical_operation_diagonal_memory(memory, 0, 1, 2, function_7);
    word answer = read_from_diagonal_memory(memory, 2);
    for (int i = 0; i < WORD_SIZE; ++i) printf("%d", answer.digit[i]);
    printf("\nFUNCTION_8(0, 1, 2): ");
    logical_operation_diagonal_memory(memory, 0, 1, 2, function_8);
    answer = read_from_diagonal_memory(memory, 2);
    for (int i = 0; i < WORD_SIZE; ++i) printf("%d", answer.digit[i]);
    printf("\n\nFUNCTION_2(0, 1, 2): ");
    logical_operation_diagonal_memory(memory, 0, 1, 2, function_2);
    answer = read_from_diagonal_memory(memory, 2);
    for (int i = 0; i < WORD_SIZE; ++i) printf("%d", answer.digit[i]);
    printf("\nFUNCTION_13(0, 1, 2): ");
    logical_operation_diagonal_memory(memory, 0, 1, 2, function_13);
    answer = read_from_diagonal_memory(memory, 2);
    for (int i = 0; i < WORD_SIZE; ++i) printf("%d", answer.digit[i]);
    printf("\n\n");
